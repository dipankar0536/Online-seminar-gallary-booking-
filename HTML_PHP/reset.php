...
if($_SERVER['REQUEST_METHOD'] == 'POST') 
  { 
      ...
      if($mypassword1 == $mypassword2){
         ...
         $sql = "UPDATE user SET password='$mypassword1' WHERE email='$myemail'"; 
         $result = mysqli_query($db,$sql);
         
         if($result){
          $message = "Password reset successfully,click ok to go login page.";
      ...
      <table class="assult">
           ...
           <center> <h1> password reset</h1></center>
             ...
             <tr>
            	...
            	<td class="pssd">
     		    	<input type="text" placeholder="<?php echo $mydept;?>" name="dept_name"  readonly>
     	        </td>
             </tr>
