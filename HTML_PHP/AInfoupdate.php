...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/AInfoupdate.css">
...
<body>
 ...
 <ul>
  ...
  <form class="loginbox" id="second" action="Aupdate.php" method="post">
      ...
      <table class="assult">
        ...
        <tr>
          <th >
            ...
            <td class="pssd1">
              <input type="text" placeholder="<?php echo $row['email_id'];?>" name="email" pattern="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" title="Please valid email id !!!" >
            </td>
        </tr>
