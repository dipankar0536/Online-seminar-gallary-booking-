...
<header>
  ...
  <form  class="loginbox" id="second" action="plogin.php" method="post">
  	<img src="..\pic\avatar3.png" class="avatar"/>
  	<h2>LOG  IN</h2>    
  	<div class="textbox">
  	<i class="fa fa-user"></i>
    <input type="text" placeholder="Department Name" name="username" required="" >		
  	</div>
  	<div class="textbox1">
    ...
    <input type="password" placeholder="Password" name="password" required="" >		
     ...
     <a href="forgotpass.php" class="wax"><u>forgot password</u>? <u class="wax1">click here</u>.</a> 
   </form>
  </header>
 </body>  
</html>
